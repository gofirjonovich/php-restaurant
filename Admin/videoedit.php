...
if (isset($_POST['send'])) {
    ...
    $videos=mysqli_fetch_assoc($query);
    if (isset($_POST['send'])) {
        $name=$_POST['name'];
        $body=$_POST['body'];
        $v=$_FILES['video']['name'];
        ...
        $sql2=" UPDATE video SET name='$name',  body='$body', video='$v' where id='$id'";
...
$id1=$_GET['id'];
$sql3="SELECT * FROM video where id='$id1'";
$query3=mysqli_query($connect, $sql3) or die(mysqli_error($connect));
$vs=mysqli_fetch_assoc($query3)
?>
...
<div class="card card-success">
    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            <input class="form-control form-control-lg" value="<?php echo $vs['name'];?>" type="text" placeholder="" name="name">
            <br>
            <input class="form-control form-control-lg" type="text"  value="<?php echo $vs['body'];?>" name="body">
            <br>
            <label for="exampleInputFile">Rasm tanlang</label>
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" value="<?php echo $vs['video'] ?>" class="custom-file-input" id="exampleInputFile" name="video">
