...
if (isset($_POST['send'])) {
    ...
    if (isset($_POST['send'])) {
        ...
        $sql2=" UPDATE features SET name='$name', about='$about', icon='$pic'  where id='$id'";
...
$id1=$_GET['id'];
$sql3="SELECT * FROM features where id='$id1'";
...
<div class="card card-success">
    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            <input class="form-control form-control-lg" value="<?php echo $f['name'];?>" type="text" placeholder="" name="name">
            <br>
            <input class="form-control form-control-lg" type="text"  value="<?php echo $f['about'];?>" name="about">
            <br>
            <label for="exampleInputFile">Rasm tanlang</label>
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" value="<?php echo $f['pic'] ?>" class="custom-file-input" id="exampleInputFile" name="pic">
