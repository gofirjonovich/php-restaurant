...
if (isset($_POST['send'])) {
    ...
    if (isset($_POST['send'])) {
        ...
        $sql2=" UPDATE header SET name='$name',  about='$about', pic='$pic' where id='$id'";
...
$id1=$_GET['id'];
$sql3="SELECT * FROM header where id='$id1'";
$query3=mysqli_query($connect, $sql3) or die(mysqli_error($connect));
$part=mysqli_fetch_assoc($query3)
?>
...
<div class="card card-success">
    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            <input class="form-control form-control-lg" value="<?php echo $part['name'];?>" type="text" placeholder="" name="name">
            <br>
            <input class="form-control form-control-lg" type="text"  value="<?php echo $part['about'];?>" name="about">
            <br>
            <label for="exampleInputFile">Rasm tanlang</label>
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" value="<?php echo $part['pic'] ?>" class="custom-file-input" id="exampleInputFile" name="pic">
