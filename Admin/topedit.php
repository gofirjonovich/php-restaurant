...
if (isset($_POST['send'])) {
    $id=$_GET['id'];
    $sql="SELECT * FROM topdish where id='$id'";
    $query=mysqli_query($connect, $sql) or die(mysqli_error($connect));
    $topdishes=mysqli_fetch_assoc($query);
    if (isset($_POST['send'])) {
        $name=$_POST['name'];
        $about=$_POST['about'];
        $pic=$_FILES['pic']['name'];
        ...
        $sql2=" UPDATE topdish SET name='$name', image='$pic', about='$about' where id='$id'";
...
$id1=$_GET['id'];
$sql3="SELECT * FROM topdish where id='$id1'";
$query3=mysqli_query($connect, $sql3) or die(mysqli_error($connect));
$top=mysqli_fetch_assoc($query3)
?>
...
<div class="card card-success">
    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            <input class="form-control form-control-lg" value="<?php echo $top['name'];?>" type="text" placeholder="" name="name">
            <br>
            <input class="form-control form-control-lg" type="text"  value="<?php echo $top['about'];?>" name="about">
            <br>
            <label for="exampleInputFile">Rasm tanlang</label>
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" value="<?php echo $top['image'] ?>" class="custom-file-input" id="exampleInputFile" name="pic">
