<?php include('./configes/db.php'); ?>
<?php include('./header.php') ?>

			
<?php include('./configes/headerpart.php'); ?>
			
<?php include('./configes/topdish.php'); ?>

<?php include('./configes/video.php'); ?>		
			
<?php include('./configes/features.php'); ?>

<?php include('./configes/menus.php'); ?>

<?php include('./configes/chefs.php'); ?>	

<?php include('./configes/blogs.php') ?>
					...
					<div class="row align-items-center d-flex justify-content-start">
						...
						<div class="col-lg-4 col-md-12 pt-100 pb-100">
							<form class="form-area" id="myForm" action="mail.php" method="post" class="contact-form text-right">
								...
								<button class="primary-btn mt-20" name="send">Send Message<span class="lnr lnr-arrow-right"></span></button>
